        ...
        <a-row :gutter="48">
          <a-col  :xl="5" :lg="6" :md="8" :sm="24">
            <a-form-item label="报告标题">
              <j-dict-select-tag type="list" v-model="queryParam.id" placeholder="请选择报告标题" dictCode="titleBG"  />

            </a-form-item>
          </a-col>
          <a-col :xl="5" :lg="6" :md="8" :sm="24">
            <a-form-item label="报告类型">
              <j-dict-select-tag type="list" v-model="queryParam.status" placeholder="请选择报告类型" dictCode="valid_statuss"  />

            </a-form-item>
          </a-col>
          <a-col :xl="5" :lg="6" :md="8" :sm="24">
            <a-form-item label="报告模版">
...
export default {
  ...
  methods: {
    ...
    look(records) {
      console.log(records)
      this.$router.push(`/zbtest/cblbdetail/${records.key}`)
    },
    handleEdit (record) {
