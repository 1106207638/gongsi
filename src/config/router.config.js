...
export const asyncRouterMap = [

  {
    ...
    children: [
      {
        path: '/zbtest/cblbdetail/:id',
        name: 'cblbdetail',
        component: () => import('@/views/zbtest/cblbdetail'),
        meta: { title: '采报详情', permission: [ 'dashboard' ] }
      },
      // // dashboard
      // {
      //   path: '/dashboard',
...
export const constantRouterMap = [
  ...
  children: [
    ...
    {
      path: '/zbtest/zbjcLook/:id',
      name: 'zbjcLook',
      component: () => import('@/views/zbtest/zbjcLook'),
      meta: { title: '作战任务详情', permission: [ 'dashboard' ] }
    },
    {
      path: '/onLine/form',
      name: 'onLineForm',
      component: () => import('@/views/online/form'),
      meta: { title: '在线表单', permission: [ 'dashboard' ] }
    },
    {
      path: '/onLine/selfcgreport',
      name: 'selfcgreport',
      component: () => import('@/views/online/selfcgreport'),
      meta: { title: '报表配置', permission: [ 'dashboard' ] }
    },
    {
      path: '/zbtest/zbjcAdd',
      name: 'zbjcAdd',
      component: () => import('@/views/zbtest/zbjcAdd'),
      meta: { title: '值班检查添加', permission: [ 'dashboard' ] }
    },
  ]},
  {
    path: '/user',
