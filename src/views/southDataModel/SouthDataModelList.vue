<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="模板名称">
              <j-input placeholder="请输入模板名称" v-model="queryParam.modelName"></j-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="url.uploadUrl" >
        <a-button type="primary" icon="import">上传文件</a-button>
      </a-upload>
      <a-button type="primary" icon="download" @click="handleExportXls('报表模板表')">导出</a-button>
...
<!--      </a-upload>-->
    ...
    <south-data-model-copy-modal ref="modalForm" @ok="modalFormOk"></south-data-model-copy-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'modelFileName',text:'文件名称',dictCode:''})
        fieldList.push({type:'string',value:'modelFileSize',text:'文件大小',dictCode:''})
        fieldList.push({type:'string',value:'modelFileType',text:'文件格式',dictCode:''})
